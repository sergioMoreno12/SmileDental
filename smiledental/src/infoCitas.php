...
if (!isset($_SESSION['dentist']) || !isset($_GET["id_cita"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['motivo']) && isset($_FILES['historia'])) {
        $idCita = $_GET["id_cita"];
        $texto = $_POST['motivo'];
        ...
        $cita = new Cita();
        $registro = $cita->updateDocs($idCita, $texto, $fileName, $fileContent);
    }
}
?>
    ...
    <div class="row text-center justify-content-center">
        <div class="col-6 mt-5">
            <form action="" method="post" class="bg-light" enctype="multipart/form-data">
                ...
                <textarea name="motivo" id="" cols="30" rows="10" placeholder="Aquí el motivo de consulta"></textarea>
                <div class="input">
